...
class MainActivity : AppCompatActivity(),SearchCityCallback {
    ...
    class MyLocationListener : BDAbstractLocationListener() {
        override fun onReceiveLocation(location: BDLocation?) {
            ...
            if (location != null&& location.latitude != 4.9E-324 && location.longitude != 4.9E-324) {
                //获取纬度信息
